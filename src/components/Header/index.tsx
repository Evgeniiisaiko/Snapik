                ...
                <div className="headerBlock f-row-betw">
                    ...
                    <Link className={styles.logoLink} to={'/'}>
                        <div className={`${styles.headerLogo} f-column al-center gap-5`}>
                            <svg width="160" height="80" viewBox="0 0 390 128" fill="none"
                                ...
                                <g clip-path="url(#clip0_703_4421)">
                                    ...
                                    <path
                                        ...
                                        fill="black" />
                                    <path d="M127.338 86V63.28H118.378V58H142.778V63.28H133.818V86H127.338Z"
                                        fill="black" />
                                    ...
                                    <path
                                        ...
                                        stroke="#D900B6" stroke-width="6" stroke-linecap="round"
                    ...
                    <div className={`${styles.headerRight} gap-30 c-white d-f al-center`}>
                        <div className={`${styles.headerNav} d-f gap-30`}>
                            ...
                            <Link to={'/seen'}>
                                <div className={`${styles.headerNavItem} f-column al-center gap-5 hover-scale`}>
                                    ...
                                    {
                                        seenItems.length ?
                                            <CountBlock value={seenItems.length} className={styles.headerCountSeen} /> : null
                                    }
                        ...
                        <div className={`${styles.headerContacts} d-f al-center gap-30`}>
                            <a href="" className={`${styles.headerPhone} d-f al-center gap-10`}>
                            ...
                            <div className={`${styles.headerSocial} d-f al-center gap-20`}>
                                <a href="" className={`${styles.headerSocialItem} f-c-row hover-scale`}>
                    ...
                    <div onClick={openMenu} className={styles.headerBurger}>
                        <svg width="30" height="30" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0 4C0 1.79086 1.79086 0 4 0H9V5C9 7.20914 7.20914 9 5 9H0V4Z" fill="white" />
                            <path d="M11 4C11 1.79086 12.7909 0 15 0H20V5C20 7.20914 18.2091 9 16 9H11V4Z"
                                fill="white" />
                            <path d="M0 15C0 12.7909 1.79086 11 4 11H9V16C9 18.2091 7.20914 20 5 20H0V15Z"
                                fill="white" />
                            <path d="M11 15C11 12.7909 12.7909 11 15 11H20V16C20 18.2091 18.2091 20 16 20H11V15Z"
                                fill="white" />
                        </svg>
                    </div>
                </div>
