...
const ExcursionsSlider: FC<ExcursionsSliderProps> = ({ excursions, mbClassName, sliderMargin }) => {
    const sliderExcursionsRef = useRef<SwiperProps>(null)
        ...
        <div className={"p-rel"}>
            {
                !disabledArrows ? 
                <>
                    <div className={`${styles.sliderBtnWrapper} ${styles.sliderBtnLeft} f-c-col p-abs top-0`}>
                        <svg onClick={handlePrev} className={"bx-shadow circle hover-scale"} xmlns="http://www.w3.org/2000/svg"
                            ...
                            <path
                                ...
                                fill="black" stroke="#D900B6" />
                        </svg>
                    </div>
                    <div className={`${styles.sliderBtnWrapper}  ${styles.sliderBtnRight} f-c-col p-abs top-0`}>
                        <svg onClick={handleNext} className={"bx-shadow circle hover-scale"} xmlns="http://www.w3.org/2000/svg"
                            width="49" height="49" viewBox="0 0 49 49" fill="none">
            ...
            >
                {
                    excursions.map(item => (
                        ...
                        <SwiperSlide>
                            <ExcursionCard classNameMobile={mbClassName}
                                {...item}
                            />
                        </SwiperSlide>
