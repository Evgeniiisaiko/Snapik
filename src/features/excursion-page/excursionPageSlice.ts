...
export const createReview = createAsyncThunk(
  ...
  async (request: CreateReviewRequest, { dispatch }) => {
    const res: AxiosResponse<CreateReviewResponse> = await handleTokenRefreshedRequest(ReviewServiceApi.Create, request)
    return res.data
  }
)
export const createOrder = createAsyncThunk(
  ...
  async (request: CreateOrderRequest, { dispatch }) => {
    const res: AxiosResponse<OrderApi> = await handleTokenRefreshedRequest(UserApi.CreateOrder, request)
    return res.data
  }
)
