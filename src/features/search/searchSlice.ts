...
import { SearchRequest } from '../../types/api/search.api.types';
...
export const SearchSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        // EXCURSIONS
        builder.addCase(getSearchedExcursions.fulfilled, (state, action) => {
            state.results = action.payload
            state.loadings.excursions = false
        })
        builder.addCase(getSearchedExcursions.pending, (state, action) => {
            state.loadings.excursions = true
        })
        builder.addCase(getSearchedExcursions.rejected, (state, action) => {
            state.loadings.excursions = false
        })
    },
});
