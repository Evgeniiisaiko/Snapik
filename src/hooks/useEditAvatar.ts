...
import { ASPECT_RATIO, MAX_FILE_SIZE, MIN_DIMENSION } from '../components/Modals/EditAvatar/settingsAvatar';
import { resetCrop, setCrop, setErr, setImgSrc, setPreviewCrop, setStep } from '../features/edit-avatar/main';
