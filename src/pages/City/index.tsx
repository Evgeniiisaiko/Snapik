...
import { getExcursion } from '../../features/excursion-page/excursionPageSlice';
...
const City: FC = () => {
    ...
    const { city_data, reviews, categories, excursions, loadings, pageStatus } = useAppSelector(state => state.cityPageData)
                            ...
                            <WelcomeLayout backgroundURL={`${city_data.main_photo}`}>
                                <div className="wrapper h-100p c-white p-rel ">
                                    <div
                                        ...
                                        <h1 className="txt-center">Эксклюзивные экскурсии в городе {city_data.name}</h1>
                            ...
                            <FeaturesSection />
                            {
                                !isMobile ?
                                    <>
                                        ...
                                        <PopularExcursionsSection excursions={excursions} titleSection={`Экскурсии в городе ${city_data.name} от ${city_data.city_min_price} руб.`} isSlider={true} />
                                    </> :
                                    <>
