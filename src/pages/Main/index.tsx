...
const Main: FC = () => {
    ...
    const { popularCategories, popularReviews, loadings, popularExcursions } = useAppSelector(state => state.mainData)
                ...
                <WelcomeLayout backgroundURL={getImgPath('main_bg.jpg')}>
                    <div className="wrapper h-100p c-white p-rel">
                        <div className={`${styles.WelcomeBlock} h-100p f-c-col w-100p gap-40`}>
                            ...
                            <Link to={"/search"} className={`${styles.WelcomeSearch} al-center d-f`}>
