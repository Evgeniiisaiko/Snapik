import { CityApi } from "./cities.types";
import { HasID } from "./common.types";
import { ExcursionDetailsApi } from "./details.types";

export type ExcursionsFilterVariant = "cost" | "-cost" | "count_of_books" | "-people_limit" | "people_limit"
...
export type ExcursionProps = Pick<ExcursionApi,
  "id" | "main_photo" | "title" | "duration" | "rating" | "ex_type" | "tour_price" | "cost" | "city" | "transport" | "description" | "people_limit" | "guide"
>
