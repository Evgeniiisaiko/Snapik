import { editAvatarUser } from "../../features/profile/profileSlice";
...
export async function getAvatarForm(previewCanvas: HTMLCanvasElement | null) {
    ...
    const photo = await getImage({ canvas: previewCanvas, width: 150, height: 150, mime: "image/jpeg", quality: 1 }) as Blob;
